...
import {ISugarLottery} from "lottery/contracts/interfaces/ISugarLottery.sol";
...
contract BunnySpecialLottery is Ownable {
    ...
    ISugarLottery public pancakeSwapLottery;
    ...
    constructor(
        ...
        pancakeSwapLottery = ISugarLottery(_pancakeSwapLotteryAddress);
